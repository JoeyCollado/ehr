...
const Doctors = () => {
  return (
    <div className="relative p-4 font-sans">
      ...
      <div className="flex flex-col md:flex-row gap-8 pb-10">
        ...
        <div className="flex flex-col items-start">
          ...
          <div>
            ...
            <h2 className="text-xl font-semibold mt-13">PEDIATRICS</h2>
          </div>
        </div>

        {/* Right Section - Contact Info */}
        <div className="md:ml-auto flex flex-col justify-center mt-52">
      ...
      <div className="absolute bottom-0 left-0 right-0 h-10 bg-green-400 rounded-md"></div>
    </div>
  );
};
