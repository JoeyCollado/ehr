        ...
        <div className="min-h-screen bg-[#faf6f6] flex items-center justify-center pb-4 mb-[5%]">
          <div className="w-full max-w-4xl bg-white text-black shadow-lg rounded-lg p-6 ">
            ...
            <div className="grid grid-cols-2 gap-4 border-b p-2">
              ...
              <input
                className="border p-1"
                placeholder="@akosijoeyaibertcollado@gmail.com"
                name="email"
            ...
            <div className="grid grid-cols-5 gap-4 border-b p-2">
              ...
              <label>
                <input
                  ...
                  name="employment"
                  value="child"
                  checked={formData.employment === "child"}
                  onChange={handleInputChange}
                  disabled={!isEditing}
                />{" "}
                Child
              ...
              <label>
                <input
                  ...
                  name="employment"
                  value="homemaker"
                  checked={formData.employment === "homemaker"}
                  onChange={handleInputChange}
                  disabled={!isEditing}
                />{" "}
                Homemaker
            ...
            <div className="grid grid-cols-5 gap-4 border-b p-1">
              ...
              <label>
                <input
                  ...
                  name="referral"
                  value="family"
                  checked={formData.referral === "family"}
                  onChange={handleInputChange}
                  disabled={!isEditing}
                />{" "}
                Family Member
              ...
              <label>
                <input
                  ...
                  name="referral"
                  value="news"
                  checked={formData.referral === "news"}
                  onChange={handleInputChange}
                  disabled={!isEditing}
                />{" "}
                News
              ...
              <label>
                <input
                  ...
                  name="referral"
                  value="other"
                  checked={formData.referral === "other"}
                  onChange={handleInputChange}
                  disabled={!isEditing}
                />{" "}
                Other
            ...
            <div className="grid grid-cols-5 gap-4 border-b p-1">
              <h2 className="pl-2">Relationship to patient :</h2>
              <label>
                <input
                  type="radio"
                  name="relationship"
            ...
            <div className="grid grid-cols-6 gap-4 border-b p-2">
              <h2 className="pl-1 pt-1">Last Name :</h2>
              <input
                className="border p-1"
                placeholder="Last Name"
                ...
                readOnly={!isEditing}
              />
              <h2 className="pl-1 pt-1">First Name :</h2>
              <input
                className="border p-1"
                placeholder="First Name"
                ...
                readOnly={!isEditing}
              />
              <h2 className="pl-1 pt-1">Middle Initial :</h2>
              <input
                className="border p-1"
                placeholder="Middle Initial"
                name="guarantorMiddleInitial"
                value={formData.guarantorMiddleInitial || ""}
                onChange={handleInputChange}
                readOnly={!isEditing}
              />
            </div>
            ...
            <div className="grid grid-cols-2 gap-4 border-b p-2">
              <h2 className="pl-1 pt-1">Email Address :</h2>
              <input
                className="border p-1"
                placeholder="@akosijoeyaibertcollado@gmail.com"
                name="guarantorEmail"
            ...
            <div className="grid grid-cols-4 gap-4 border-b p-2">
              <h2 className="pl-1 pt-1">Employer :</h2>
              <input
                className="border p-1"
                placeholder="Employer"
                ...
                readOnly={!isEditing}
              />
              <h2 className="pl-1 pt-1">Employer Phone :</h2>
              <input
                className="border p-1"
                placeholder="Employer Phone"
                name="guarantorEmployerPhone"
                value={formData.guarantorEmployerPhone || ""}
                onChange={handleInputChange}
                readOnly={!isEditing}
              />
            </div>
            ...
            <div className="grid grid-cols-6 gap-4 border-b p-2">
              ...
              <input
                ...
                disabled={!isEditing}
              />
              <h2 className="pl-1 pt-1">Relationship to Patient :</h2>
              <input
                className="border p-1"
            ...
            <div className="grid grid-cols-6 gap-4 border-b p-2">
              <h2 className="pl-1 pt-1">Home Phone :</h2>
              <input
                className="border p-1"
                placeholder="Home Phone"
                ...
                readOnly={!isEditing}
              />
              <h2 className="pl-1 pt-1">Work Phone :</h2>
              <input
                className="border p-1"
                placeholder="Work Phone"
                ...
                readOnly={!isEditing}
              />
              <h2 className="pl-1 pt-1">Other Phone :</h2>
              <input
                className="border p-1"
                placeholder="Other Phone"
                name="emergencyOtherPhone"
                value={formData.emergencyOtherPhone || ""}
                onChange={handleInputChange}
                readOnly={!isEditing}
              />
            </div>
            ...
            <div className="grid grid-cols-6 gap-4  p-2">
              ...
              <input
                className="border p-1"
                placeholder="Other Phone"
                name="otherOtherPhone"
                value={formData.otherOtherPhone || ""}
                onChange={handleInputChange}
                readOnly={!isEditing}
              />
            </div>
